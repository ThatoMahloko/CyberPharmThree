...
const Profile = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            <Card style={styles.doctorCover}>
                {
                    user.photoURL !== null ?
                        <>
                            ...
                            {
                                fullProfile.filter(email => email.id === myUser.email)
                                .map((userData)=>{
                                    return(
                                        <Text style={styles.usePhone}>{userData.PhoneNumber}</Text>
                                    )
                                })
                            }
                        </>
            ...
            <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('EditProfile', myUser)}>
