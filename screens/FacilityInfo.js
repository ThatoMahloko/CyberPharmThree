...
const FacilityInfo = ({ route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            />
            <ScrollView>
                <Text style={styles.mainHeading}>{route.params.name}</Text>
                <Image style={styles.locationLogo} source={require('../assets/locationIcon.png')} />
                <Text style={styles.locationText}>{route.params.address}</Text>
                ...
                <Text style={styles.info}>{route.params.about}</Text>
